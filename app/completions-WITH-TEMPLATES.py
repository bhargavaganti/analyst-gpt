...
def generate_gpt4_response(prompt, modality, api_key):
    ...
    if modality == "business analyst":
        ...
        user_prompt = f"Please generate a response about {prompt} from the perspective of an investigator. Start with this introduction sentence: '{intro_sentence}'.  List 3 investigative insights for {prompt} using the bullet point format • under the subheading 'General Investigative Information'. List 3 corporate facts for {prompt} using the bullet point format • under the subheading 'Corporate Information'. List 3 compliance findings for {prompt} using the bullet point format • under the subheading 'Compliance Information'. "
        ...
        user_prompt = f"Please generate a response about {prompt} from the perspective of an financial analyst. Start with this introduction sentence: '{intro_sentence}'.  Create a first subheading 'Assets & Liabilities'. List 3 key Assets and Liabilities insights for {prompt} using the bullet point format • . Create a second subheading 'Cashflows & Liquidity'. List 3 insights regarding cashflows and liquidity information for {prompt} using the bullet point format • . Create a third subheading 'Key Financial Ratios'. List 3 key financial ratios with the relevant values for {prompt} iusing the bullet point format • "
